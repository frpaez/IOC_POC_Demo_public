...
WebUI.setText(findTestObject('Object Repository/Page_XYZ Bank/input_Amount to be Deposited_form-control n_97f4dd'), '6000')

WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/form_Amount to be Deposited Deposit'))
