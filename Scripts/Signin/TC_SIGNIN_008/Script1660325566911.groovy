...
WebUI.setText(findTestObject('Object Repository/Page_MySmartStore Ecommerce/Page_Shop. Register/input_Email_Email'), 'mail.com')
...
WebUI.click(findTestObject('Page_MySmartStore Ecommerce/Page_Shop. Register/Page_Shop. Register/span_Email is not a valid email address'))

WebUI.click(findTestObject('Page_MySmartStore Ecommerce/Page_Shop. Register/Page_Shop. Register/span_Password must be between 6 and 999 characters'))

WebUI.click(findTestObject('Page_MySmartStore Ecommerce/Page_Shop. Register/Page_Shop. Register/span_The password and confirmation password do not match'))
